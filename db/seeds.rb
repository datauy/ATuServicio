...
News.create!(head: "Un canal con el MSP", title: "Sobre A Tu Servicio", description: "Explorá el listado de prestadoredolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.", link: '/sobre-el-proyecto', is_active: true)
News.create!(head: "Catálogo online", title: "Tomá una desición informada", description: "Explorá el listado de prestadoredolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.", link: '/comparar', is_active: true)
News.create!(head: "Un canal con el MSP", title: "Tercer ítem", description: "Explorá el listado de prestadoredolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.", link: '/sobre-el-proyecto', is_active: true)